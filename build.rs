...
fn main() -> Result<()> {
    ...
    let mut f = File::create("src/generated/alpha.rs")?;
    f.write_all(generated.to_string().as_bytes())?;

    // Region
    let generated = generate_region(&definitions);
    let mut f = File::create("src/generated/region.rs")?;
    f.write_all(generated.to_string().as_bytes())?;

    // Definition
    let generated = generate_definition(&definitions);
    let mut f = File::create("src/generated/definition.rs")?;
    f.write_all(generated.to_string().as_bytes())?;
